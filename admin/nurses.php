            ...
            <div class="layout-px-spacing">
                <div class="row layout-top-spacing" id="cancel-row">
                    <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                        ...
                        <div class="widget-content widget-content-area br-6">
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        <?php
                                        $query = mysqli_query($connection, "SELECT user_id, fname, lname, nid, gender, email, phone FROM users WHERE role='nurse'") or die(mysqli_error($connection));
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton<?php echo $no; ?>">
                                                            ...
                                                            <a class="dropdown-item" href="deleteme.php?id=<?php echo urlencode($data['user_id']); ?>" onclick="return confirm('Are you sure you want to delete this user?');">Delete</a>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                        ...
                        <a href="addnurse.php?service" class="btn btn-primary btn-rounded btn-floated"><i data-feather="plus-circle"></i> Add a user</a>
                    </div>
                </div>
            </div>
