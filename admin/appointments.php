...
$query = mysqli_query($connection, "SELECT * FROM  appointment ORDER BY appointment_id DESC") or die(mysqli_error($connection));
$no = 0;
while ($data = mysqli_fetch_assoc($query)) {
    ...
    <tr>
        ...
        <td><?php print($data["mother"]); ?></td>
        <td><?php print($data["Child"]); ?></td>
        <td><?php print($data["appointment_date"]); ?></td>
        <td><?php print($data["phone"]); ?></td>
        <td><?php print($data["pediatrician"]); ?></td>
        <td><?php print($data["request_status"]); ?></td>
  ...
  <td>
                        ...
                        <!-- <a href="adduser.php?service= " class="btn btn-primary btn-rounded btn-floated"><i
                                    data-feather="plus-circle"></i> Add user</a> -->
                    </div>
