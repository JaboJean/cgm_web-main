            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($connection, "SELECT * FROM  seasons  ORDER BY season_id  DESC") or die(mysqli_error($connection));
                                        $no = 0;
                                        while ($data = mysqli_fetch_assoc($query)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php print($data["start_from"]); ?></td>
                                                <td><?php print($data["end_on"]); ?></td> <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item text-danger" href="?deleteseason=<?php print($data["season_id"]); ?>">Delete</a>
                                                        </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
                        ...
                        <a href="addSeason" class="btn btn-primary btn-rounded btn-floated"><i data-feather="plus-circle"></i></a>
