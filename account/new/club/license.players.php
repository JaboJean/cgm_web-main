...
<body class="sidebar-noneoverflow">
                                                ...
                                                <td>
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item text-info" href="?=<?php print($data["PlayerId"]); ?>">Edit</a>
                                                            <a class="dropdown-item text-danger" href="?=<?php print($data["PlayerId"]); ?>">Delete</a>
                                                        </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".playersLicense").addClass("active");
            App.init();
        });
    </script>
