            ...
            <div class="layout-px-spacing">
                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($connection, "SELECT * FROM  competitions ORDER BY competition_id DESC") or die(mysqli_error($connection));
                                        $no = 0;
                                        while ($data = mysqli_fetch_assoc($query)) {
                                            $no++; ?>
                                            <tr>
                                                <td><?php print($no) ?></td>
                                                <td><?php print($data["season"]); ?></td>
                                                <td><?php print($data["name"]); ?></td>
                                                <td><?php print($data["abreviation"]); ?></td>
                                                <td><?php print($data["category"]); ?></td>
                                                <td><?php print($data["begin_date"]); ?></td>
                                                <td><?php print($data["end_date"]); ?></td>
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item text-danger" href="?=<?php print($data["coachId"]); ?>">Delete</a>
                                                        </div>
                                                </td>
                                            </tr>
                                        <?php } ?>
                        ...
                        <a href="addCompetitions" class="btn btn-primary btn-rounded btn-floated"><i data-feather="plus-circle"></i></a>
