                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($connection, "SELECT * FROM  admins ORDER BY admin_id DESC") or die(mysqli_error($connection));
                                        $no = 0;
                                        while ($data = mysqli_fetch_assoc($query)) {
                                            $no++; ?>
                                            <tr>
                                                <td><?php print($no) ?></td>
                                                <td><?php print($data["admin_name"]); ?></td>
                                                <td><?php print($data["admin_phone"]) ?></td>
                                                <td><?php print($data["admin_email"]) ?></td>
                                                <td><?php print($data["admin_status"]) ?></td>
