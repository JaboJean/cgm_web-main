                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($connection, "SELECT * FROM  transfers , players, clubs  WHERE players.player_id = transfers.player_id AND clubs.club_id = transfers.club_id_from AND transfers.club_id_from ='$CLUBID'") or die(mysqli_error($connection));
                                        $no = 0;
