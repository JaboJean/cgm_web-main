                        ...
                        <div class="skills layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <!-- <div class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Last Name" name="licenseId" value="<?php print "FRB" . rand();  ?>" readonly >
                                            </div>
                                        </div> -->
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <select class="form-control basic" name='clubId' required>
                                                    <option value="">Club</option>
                                                    <?php
                                                    require("configs/connection.php");
                                                    $query = mysqli_query($connection, "SELECT * FROM clubs") or die(mysqli_error($connection));
                                                    while ($data = mysqli_fetch_assoc($query)) {
                                                    ?>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="" name="jerseyNo" value="" required >
                                            </div>
                                        </div>
                                    ...
                                    <button class="btn btn-primary" type="submit" name="addPlayer">Save Info</button>
                                </form>
                            </div>
                        </div>
                    </div>
