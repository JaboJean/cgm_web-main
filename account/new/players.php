                            ...
                            <div class="user-profile layout-spacing">
                                <div class="widget-content widget-content-area">
                                    <div class="d-flex justify-content-between">
                                        <h3 class="">Profile</h3>
                                        <!-- <a href="editClientInfo?client=" class="mt-2 edit-profile"> <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                                <path d="M12 20h9"></path>
                                                <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                                            </svg></a> -->
                                    </div>
                                    <div class="text-center user-info">
                                        <img src="http://E-TUNGO.itdevs.rw/catalog/pictures/<?php print($data["profile_picture"]); ?>" alt="avatar">
                                        <p class=""></p>
                                    </div>
                                ...
                                <div class="table-responsive mb-4 mt-4">
                                    <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $query = mysqli_query($connection, "SELECT * FROM  players, countries WHERE players.country_id = countries.country_id  ORDER BY player_id  DESC") or die(mysqli_error($connection));
                                            $no = 0;
                                            while ($data = mysqli_fetch_assoc($query)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="badge badge-<?php if ($data["player_status"] == "Payment Required") { ?>warning<?php } else { ?>info<?php } ?>"><?php print($data["player_status"]); ?></span></td>
                                                    <td>
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                ...
                                                                <?php if ($data["player_status"] == 'pending') { ?>
                                                                    <a class="dropdown-item text-success" href="?approveP=<?php print($data["player_id"]); ?>">Approve</a>
                                                                    <a class="dropdown-item text-danger" href="?denyP=<?php print($data["player_id"]); ?>">Deny</a>
                                                                <?php } else { ?>
                                                                    <a class="dropdown-item text-danger" href="?deleteP=<?php print($data["player_id"]); ?>">Delete</a>
                                                                <?php } ?>
                                                            </div>
                                                    </td>
                                                </tr>
