                        ...
                        <div class="card-body">
                            <form id="registrationForm" method="post" enctype="multipart/form-data" class="pb-5">
                                ...
                                <ul class="nav nav-tabs mb-3" id="registration-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="parent-tab" data-toggle="tab" href="#parent-info" role="tab" aria-controls="parent-info" aria-selected="true">Parent Information</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <div class="tab-content" id="registration-tabs-content">
                                    ...
                                    <div class="tab-pane fade show active" id="parent-info" role="tabpanel" aria-labelledby="parent-tab">
                                        ...
                                        <div class="form-group">
                                            <label for="phone">Parent/Guardian Phone<span class="required">*</span></label>
                                    ...
                                    <div class="tab-pane fade" id="child-info" role="tabpanel" aria-labelledby="child-tab">
                                        ...
                                        <button type="button" class="btn btn-secondary" onclick="prevTab('parent-info')">Previous</button>
