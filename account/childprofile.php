...
// SQL query to fetch child details along with parent information
...
while ($data = mysqli_fetch_assoc($query)) {
    $no++;
    $statusStyle = ($data["status"] == "Incomplete") ? 'style="color: red;"' : 'style="color: green;"'; // Updated for blue
    ?>
    <tr>
        <td><?php print($no); ?></td>
        <td><?php print(htmlspecialchars($data["full_name"])); ?></td>
        <td><?php print(htmlspecialchars($data["date_of_birth"])); ?></td>
        <td><?php print(htmlspecialchars($data["join_date"])); ?></td>
        <td><?php print(htmlspecialchars($data["gender"])); ?></td>
        <td><?php print(htmlspecialchars($data["father_fname"] . ' ' . $data["father_lname"])); ?></td>
        <td><?php print(htmlspecialchars($data["mother_fname"] . ' ' . $data["mother_lname"])); ?></td>
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item update-link" href="#" data-toggle="modal" data-target="#updateModal" 
                           data-childid="<?php print($data["child_id"]); ?>" 
                           data-fullname="<?php print($data["full_name"]); ?>" 
                           data-dob="<?php print($data["date_of_birth"]); ?>" 
                           data-joindate="<?php print($data["join_date"]); ?>" 
                           data-gender="<?php print($data["gender"]); ?>" 
                           data-father="<?php print($data["father"]); ?>" 
                           data-mother="<?php print($data["mother"]); ?>" 
                           data-parentphone="<?php print($data["parent_phone"]); ?>" 
                           data-email="<?php print($data["email"]); ?>" 
                           data-weight="<?php print($data["weight"]); ?>">Update</a>
