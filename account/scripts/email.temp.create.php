...
<div class='container'>
    ...
    <div class='content'>
        <p>Hello " . $fname . ",</p>
        <p>I'm delighted to inform you that your account has been successfully created. Welcome to Worship Planning System! Below, you'll find your login credentials:</p>
        <ul>
        
        <li><strong>User id:</strong> " . $phone . "</li>
        <li><strong>Password:</strong> " . $passwords . "</li>
